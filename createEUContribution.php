...
<head>
  ...
  <title><?php echo $applicationName; ?> - Create EU Contribution</title>
...
<body>
  ...
  <div class="container">
    ...
    <h1 class="display-1">Create EU Contribution</h1><br>
    ...
    <?php //var_dump($_POST); ?>
      ...
      <form action="processor/eucontributionProcessor.php" method="post">
        ...
        <div class="form-group">
          ...
          ​<textarea id="ContributionDescription" name="ContributionDescription" class="form-control" placeholder="Enter Contribution Description" rows="5" cols="70" required="true" maxlength="255"></textarea>
        </div>

        <div class="form-group">
          <label for="BudgetDetails">Budget Details:</label>
          ​<textarea id="BudgetDetails" name="BudgetDetails" class="form-control" placeholder="Enter Budget Details" rows="5" cols="70" required="true" maxlength="255"></textarea>
        </div>
