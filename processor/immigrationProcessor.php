...
if($_POST['Action'] == "Create") {
	...
	if($Affected > 0){
		header("Location: ../viewImmigrations.php?Success=Immigration has been created!");
	} else {
		header("Location: ../viewImmigrations.php?Danger=Immigration hasn't been created!");
	}	
...
// Update	
	...
	if($Affected > 0){
		header("Location: ../viewImmigrations.php?Success=Immigration has been updated!");
	} else {
		header("Location: ../viewImmigrations.php?Danger=Immigration hasn't been updated!");
	}
...
// Delete
	...
	if(isset($_GET['ImmigrationID'])) {
		...
		if($Affected > 0){
			header("Location: ../viewImmigrations.php?Success=Immigration has been deleted!");
		}	else {
			header("Location: ../viewImmigrations.php?Danger=Immigration hasn't been deleted!");
		}
	}
