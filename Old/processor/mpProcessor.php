...
if($_POST['Action'] == "Create") {
	...
	$stmt = oci_parse($conn, "INSERT INTO MPS (COUNTRYID, EVENTID, MPFNAME, MPLNAME, MPPARTY, MPLOCATION) VALUES (:CountryID, EventID, :MPFName, :MPLName, :MPParty, :MPLocation)");
...
// Update	
	...
	$stmt = oci_parse($conn, "UPDATE MPS SET COUNTRYID = :CountryID, EVENTID = :EventID, MPFNAME = :MPFName, MPLNAME = :MPLName, MPPARTY = :MPParty, MPLOCATION = :MPLocation WHERE MPID = :MPID");
