...
<head>
  ...
  <title><?php echo $applicationName; ?> - View Countries</title>
...
<body>
  ...
  <div class="container">
    ...
    <h1 class="display-1">View Countries</h1><br>
    ...
    <table class="table table-hover">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><a onclick="javascript: return confirm('Are you sure you want to delete?');" href="processor/countryProcessor.php?CountryID=<?php echo $CountryID; ?>" class="btn btn-danger">Delete</a></td>
        </tr>
        <?php }//}  ?>
        <?php
